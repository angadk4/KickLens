...
//
// It used to also flare when the hero ball was smashed into the chalk ring. The ball is no
// longer kickable, so there is nothing to flare for and lib/flare.ts is gone.
